...
<header><small>CARE, CARRIED FORWARD</small><h1>KindHandoff<br>Submission kit.</h1><p>Prepared for Shivam Gupta. Copy the field-ready story, testing instructions, video copy, and product feedback. The working app and reproducible source are linked below.</p><div class="links"><a href="https://kindhandoff.web.app">Open the app</a><a href="https://github.com/shi1720/Amazon-Developer-Hackathon">Source code</a><a href="KindHandoff-Demo.mp4">Demo video</a><a href="KindHandoff-Captions.srt">Captions</a><a href="KindHandoff-Pitch.pdf">Pitch deck</a><a href="KindHandoff-Judge-Brief.pdf">Judge brief</a></div></header>
<main><nav aria-label="Submission fields">${panels.map(([id, title]) => `<a href="#${id}">${escape(title)}</a>`).join("")}</nav><p class="hint">Copy preserves Markdown. The demo uses a clearly disclosed AI voice and fictional household. Only enter a video URL after publication and playback verification.</p>
