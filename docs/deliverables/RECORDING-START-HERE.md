...
1. Read `Narration.txt` verbatim. It is designed for a 2:55 film with short pauses.
...
5. Import `Captions-draft.srt` into your editor. Its timings are estimated from the shot list, so align them to your actual voice before export.
